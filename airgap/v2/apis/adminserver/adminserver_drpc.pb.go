...
type drpcEncoding_File_apis_adminserver_adminserver_proto struct{}

func (drpcEncoding_File_apis_adminserver_adminserver_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_apis_adminserver_adminserver_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
	return proto.MarshalOptions{}.MarshalAppend(buf, msg.(proto.Message))
}

func (drpcEncoding_File_apis_adminserver_adminserver_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return proto.Unmarshal(buf, msg.(proto.Message))
}

func (drpcEncoding_File_apis_adminserver_adminserver_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
	return protojson.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_apis_adminserver_adminserver_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcAdminServerClient) DeleteFile(ctx context.Context, in *DeleteFileRequest) (*DeleteFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/adminserver.AdminServer/DeleteFile", drpcEncoding_File_apis_adminserver_adminserver_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcAdminServerClient) CleanTombstones(ctx context.Context, in *CleanTombstonesRequest) (*CleanTombstonesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/adminserver.AdminServer/CleanTombstones", drpcEncoding_File_apis_adminserver_adminserver_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCAdminServerDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/adminserver.AdminServer/DeleteFile", drpcEncoding_File_apis_adminserver_adminserver_proto{},
	...
	case 1:
		return "/adminserver.AdminServer/CleanTombstones", drpcEncoding_File_apis_adminserver_adminserver_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return srv.(DRPCAdminServerServer).
					CleanTombstones(
						ctx,
...
func (x *drpcAdminServer_DeleteFileStream) SendAndClose(m *DeleteFileResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_apis_adminserver_adminserver_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
