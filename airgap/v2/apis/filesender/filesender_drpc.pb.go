...
type drpcEncoding_File_filesender_filesender_proto struct{}

func (drpcEncoding_File_filesender_filesender_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_filesender_filesender_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
	return proto.MarshalOptions{}.MarshalAppend(buf, msg.(proto.Message))
}

func (drpcEncoding_File_filesender_filesender_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return proto.Unmarshal(buf, msg.(proto.Message))
}

func (drpcEncoding_File_filesender_filesender_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
	return protojson.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_filesender_filesender_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcFileSenderClient) UploadFile(ctx context.Context) (DRPCFileSender_UploadFileClient, error) {
	stream, err := c.cc.NewStream(ctx, "/filesender.FileSender/UploadFile", drpcEncoding_File_filesender_filesender_proto{})
	if err != nil {
		return nil, err
	}
...
func (x *drpcFileSender_UploadFileClient) Send(m *UploadFileRequest) error {
	return x.MsgSend(m, drpcEncoding_File_filesender_filesender_proto{})
}
...
func (x *drpcFileSender_UploadFileClient) CloseAndRecv() (*UploadFileResponse, error) {
	...
	if err := x.MsgRecv(m, drpcEncoding_File_filesender_filesender_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcFileSender_UploadFileClient) CloseAndRecvMsg(m *UploadFileResponse) error {
	...
	return x.MsgRecv(m, drpcEncoding_File_filesender_filesender_proto{})
}
...
func (c *drpcFileSenderClient) UpdateFileMetadata(ctx context.Context, in *UpdateFileMetadataRequest) (*UpdateFileMetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/filesender.FileSender/UpdateFileMetadata", drpcEncoding_File_filesender_filesender_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (DRPCFileSenderDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/filesender.FileSender/UploadFile", drpcEncoding_File_filesender_filesender_proto{},
	...
	case 1:
		return "/filesender.FileSender/UpdateFileMetadata", drpcEncoding_File_filesender_filesender_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
...
func (x *drpcFileSender_UploadFileStream) SendAndClose(m *UploadFileResponse) error {
	if err := x.MsgSend(m, drpcEncoding_File_filesender_filesender_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
