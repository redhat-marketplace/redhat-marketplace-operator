...
var DownloadCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		dc, err := NewDownloadConfig(fileName, fileId, outputDirectory, fileListPath, deleteOnDownload)
		if err != nil {
			return err
		}
...
func NewDownloadConfig(fileName string, fileId string, outputDirectory string, fileListPath string, deleteOnDownload bool) (*DownloadClient, error) {
...
func (dc *DownloadClient) closeConnection() {
...
func (dc *DownloadClient) DownloadFile(fn string, fid string) error {
...
func (dc *DownloadClient) BatchDownload() error {
