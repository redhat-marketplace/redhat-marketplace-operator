...
require (
	...
	github.com/openshift/api v0.0.0-20260225172252-64dddb8f3186 // indirect
	github.com/openshift/cluster-monitoring-operator v0.1.1-0.20251124143314-e2c1901af873 // indirect
