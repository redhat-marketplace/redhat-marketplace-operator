...
import (
	...
	"github.com/redhat-marketplace/redhat-marketplace-operator/watcher/v2/pkg/server"
...
var (
	...
	rootCmd = &cobra.Command{
		Use:   "redhat-marketplace-watcher",
		Short: "Watcher for Red Hat Marketplace.",
		Run:   run,
	}
