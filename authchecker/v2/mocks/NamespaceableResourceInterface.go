...
// NewNamespaceableResourceInterface creates a new instance of NamespaceableResourceInterface. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewNamespaceableResourceInterface(t testing.TB) *NamespaceableResourceInterface {
