...
#go run github.com/mikefarah/yq/v3 w -i $ROOT/bundle/redhat-marketplace-operator.v${VERSION}.clusterserviceversion.yaml 'metadata.annotations.containerImage' ${REGISTRY_IMAGE}
...
operator-courier verify --ui_validate_io $ROOT/deploy/olm-catalog/redhat-marketplace-operator
