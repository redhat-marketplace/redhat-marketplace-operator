...
func (in *MeterDefinitionSpec) DeepCopyInto(out *MeterDefinitionSpec) {
	*out = *in
	out.InstalledBy = in.InstalledBy
	in.VertexLabelSelector.DeepCopyInto(&out.VertexLabelSelector)
	if in.Workloads != nil {
	...
	if in.ServiceMeters != nil {
		in, out := &in.ServiceMeters, &out.ServiceMeters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.PodMeters != nil {
		in, out := &in.PodMeters, &out.PodMeters
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Services != nil {
		in, out := &in.Services, &out.Services
		*out = make([]*common.ServiceReference, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.Pods != nil {
		...
		*out = make([]*common.PodReference, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(common.PodReference)
				**out = **in
			}
		}
	}
...
func (in *MeterDefinitionStatus) DeepCopyInto(out *MeterDefinitionStatus) {
	*out = *in
	...
	if in.ServiceMonitors != nil {
		...
		*out = make([]common.NamespacedNameReference, len(*in))
		copy(*out, *in)
	}
	if in.Pods != nil {
		in, out := &in.Pods, &out.Pods
