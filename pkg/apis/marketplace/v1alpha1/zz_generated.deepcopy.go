...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RazeeDeployConfig) DeepCopyInto(out *RazeeDeployConfig) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RazeeDeployConfig.
func (in *RazeeDeployConfig) DeepCopy() *RazeeDeployConfig {
	if in == nil {
		return nil
	}
	out := new(RazeeDeployConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RazeeDeploymentSpec) DeepCopyInto(out *RazeeDeploymentSpec) {
	*out = *in
	...
	if in.RazeeDeployConfigValues != nil {
		in, out := &in.RazeeDeployConfigValues, &out.RazeeDeployConfigValues
		*out = new(RazeeDeployConfig)
		**out = **in
	}
	if in.ChildUrl != nil {
