...
func TestFilterByNamespace(t *testing.T) {
	...
	// should return: object-list of size 1
	...
	// should return: object-list of size 2
	...
	// case 4:
	// get resources in case a list with no existsing resources are available
	// should return: an object-list of 0 resourecs
	...
	// case 5:
	// passing a ServiceList with set of ListOption with no namespace
	// should return: an object-list of 1 resources
	ns2 := []corev1.Namespace{}
	serviceList2 := &corev1.ServiceList{}
	listOpts1 := client.InNamespace(testNs1.ObjectMeta.Name)
	err = FilterByNamespace(serviceList2, ns2, rclient, listOpts1)
	if err != nil {
		t.Error(err, "Could not execute FilterByNamespace")
	} else if len(serviceList2.Items) != 1 {
		t.Error("Case 5: Did not return the correct number of resrouces. Expected: 1. Actual: ", len(serviceList2.Items))
	}
