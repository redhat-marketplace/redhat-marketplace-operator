...
func CreateWithPatch(o *patch.Annotator) ApplyCreateActionOptionFunc {
...
func CreateWithStatusCondition(o UpdateStatusConditionFunc) ApplyCreateActionOptionFunc {
	return func(c *createActionOptions) error {
