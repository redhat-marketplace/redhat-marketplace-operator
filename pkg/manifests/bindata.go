...
func assetsRhmOperatorPrometheusServiceYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/rhm-operator-prometheus/service.yaml", size: 412, mode: os.FileMode(420), modTime: time.Unix(1599592935, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
