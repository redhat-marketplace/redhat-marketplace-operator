...
func assetsPrometheusDeploymentYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus/deployment.yaml", size: 3358, mode: os.FileMode(420), modTime: time.Unix(1595645833, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsPrometheusPrometheusYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus/prometheus.yaml", size: 3934, mode: os.FileMode(420), modTime: time.Unix(1595645833, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
