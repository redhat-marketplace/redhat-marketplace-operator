...
func assetsRhmOperatorPrometheusServiceYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/rhm-operator-prometheus/service.yaml", size: 389, mode: os.FileMode(420), modTime: time.Unix(1599572729, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
