...
func assetsMetricStateDeploymentYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/metric-state/deployment.yaml", size: 3833, mode: os.FileMode(420), modTime: time.Unix(1597134867, 0)}
...
func assetsReporterJobYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/reporter/job.yaml", size: 1292, mode: os.FileMode(420), modTime: time.Unix(1597134867, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
