...
func assetsPrometheusPrometheusYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus/prometheus.yaml", size: 4216, mode: os.FileMode(420), modTime: time.Unix(1596915960, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
