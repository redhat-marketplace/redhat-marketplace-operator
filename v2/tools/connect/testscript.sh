...
for sha in $shas; do
  IMAGES="--images https://connect.redhat.com/projects/5e98b6fac77ce6fca8ac859c/images,${sha},$TAG $IMAGES"
 done
...
for sha in $shas; do
  IMAGES="--images https://connect.redhat.com/projects/5f36ea2f74cc50b8f01a838d/images,${sha},$TAG $IMAGES"
done
...
for sha in $shas; do
 ...
 for sha in $shas; do
  IMAGES="--images https://connect.redhat.com/projects/5f62b71018e80cdc21edf22f/images,${sha},$TAG $IMAGES"
done
