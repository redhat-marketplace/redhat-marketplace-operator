...
RUN GRPC_HEALTH_PROBE_VERSION=v0.4.42 && \
...
RUN /bin/sh -c 'curl --retry 5 -L -O "https://mirror.openshift.com/pub/openshift-v4/$(uname -m)/clients/ocp/4.16.0/opm-linux.tar.gz" && \
