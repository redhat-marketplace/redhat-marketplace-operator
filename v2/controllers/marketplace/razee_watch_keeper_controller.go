...
// Reconciles the watch-keeper portion of RazeeDeployment (feature: registration)

// blank assignment to verify that ReconcileRazeeDeployment implements reconcile.Reconciler
var _ reconcile.Reconciler = &RazeeWatchKeeperReconciler{}

// RazeeWatchKeeperReconciler reconciles a RazeeDeployment object
type RazeeWatchKeeperReconciler struct {
...
func (r *RazeeWatchKeeperReconciler) Inject(injector mktypes.Injectable) mktypes.SetupWithManager {
	injector.SetCustomFields(r)
	return r
}

func (r *RazeeWatchKeeperReconciler) InjectCommandRunner(ccp ClientCommandRunner) error {
	r.CC = ccp
	return nil
}

func (r *RazeeWatchKeeperReconciler) InjectPatch(p patch.Patcher) error {
	r.patcher = p
	return nil
}

func (r *RazeeWatchKeeperReconciler) InjectFactory(f *manifests.Factory) error {
	r.factory = f
	return nil
}

func (r *RazeeWatchKeeperReconciler) InjectOperatorConfig(cfg *config.OperatorConfig) error {
	r.cfg = cfg
	return nil
}

// add adds a new Controller to mgr with r as the reconcile.Reconciler
func (r *RazeeWatchKeeperReconciler) SetupWithManager(mgr manager.Manager) error {
...
func (r *RazeeWatchKeeperReconciler) Reconcile(ctx context.Context, request reconcile.Request) (reconcile.Result, error) {
...
func (r *RazeeWatchKeeperReconciler) addFinalizer(razee *marketplacev1alpha1.RazeeDeployment, namespace string) error {
...
func (r *RazeeWatchKeeperReconciler) makeRazeeClusterMetaData(instance *marketplacev1alpha1.RazeeDeployment) *corev1.ConfigMap {
	cm := &corev1.ConfigMap{
...
func (r *RazeeWatchKeeperReconciler) makeWatchKeeperNonNamespace(
	instance *marketplacev1alpha1.RazeeDeployment,
) *corev1.ConfigMap {
	cm := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
...
//watch-keeper-non-namespace
func (r *RazeeWatchKeeperReconciler) makeWatchKeeperLimitPoll(
	instance *marketplacev1alpha1.RazeeDeployment,
) *corev1.ConfigMap {
	cm := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
...
func (r *RazeeWatchKeeperReconciler) makeWatchKeeperConfig(instance *marketplacev1alpha1.RazeeDeployment) *corev1.ConfigMap {
	cm := &corev1.ConfigMap{
		ObjectMeta: metav1.ObjectMeta{
...
// Creates watchkeeper config and applies the razee-dash-url stored on the Razeedeployment cr
func (r *RazeeWatchKeeperReconciler) makeWatchKeeperConfigV2(
	instance *marketplacev1alpha1.RazeeDeployment,
) *corev1.ConfigMap {
	data := map[string]string{
		"RAZEEDASH_URL":       instance.Spec.DeployConfig.RazeeDashUrl,
...
func (r *RazeeWatchKeeperReconciler) GetDataFromRhmSecret(request reconcile.Request, sel corev1.SecretKeySelector) ([]byte, error) {
	reqLogger := r.Log.WithValues("Request.Namespace", request.Namespace, "request.Name", request.Name)
...
func (r *RazeeWatchKeeperReconciler) makeWatchKeeperSecret(instance *marketplacev1alpha1.RazeeDeployment, request reconcile.Request) (corev1.Secret, error) {
...
func (r *RazeeWatchKeeperReconciler) makeCOSReaderSecret(instance *marketplacev1alpha1.RazeeDeployment, request reconcile.Request) (corev1.Secret, error) {
...
func (r *RazeeWatchKeeperReconciler) removeWatchkeeperDeployment(req *marketplacev1alpha1.RazeeDeployment) (*reconcile.Result, error) {
...
func (r *RazeeWatchKeeperReconciler) fullUninstall(
...
func (r *RazeeWatchKeeperReconciler) createOrUpdateWatchKeeperDeployment(
	instance *marketplacev1alpha1.RazeeDeployment,
) (reconcile.Result, error) {
