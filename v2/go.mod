...
require (
	...
	github.com/openshift/cluster-monitoring-operator v0.1.1-0.20250319033525-2800e3ef7f19
...
require (
	...
	github.com/openshift/library-go v0.0.0-20241106000323-9fcf3125a28e // indirect
