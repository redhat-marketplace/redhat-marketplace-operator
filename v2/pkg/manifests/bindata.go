...
func assetsPrometheusPrometheusYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus/prometheus.yaml", size: 4807, mode: os.FileMode(0644), modTime: time.Unix(1613052619, 0)}
...
func assetsPrometheusOperatorDeploymentYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus-operator/deployment.yaml", size: 3611, mode: os.FileMode(0644), modTime: time.Unix(1613052619, 0)}
...
func assetsRazeeRemoteResourceS3Yaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/razee/remote-resource-s3.yaml", size: 2049, mode: os.FileMode(0644), modTime: time.Unix(1613052619, 0)}
