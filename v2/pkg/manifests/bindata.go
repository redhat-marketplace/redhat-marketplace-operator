...
func assetsMetricStateDeploymentYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/metric-state/deployment.yaml", size: 4195, mode: os.FileMode(0644), modTime: time.Unix(1616101142, 0)}
...
func assetsSignerCaPem() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/signer/ca.pem", size: 1237, mode: os.FileMode(0644), modTime: time.Unix(1616076965, 0)}
