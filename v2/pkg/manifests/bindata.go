...
func assetsPrometheusOperatorDeploymentYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/prometheus-operator/deployment.yaml", size: 3611, mode: os.FileMode(420), modTime: time.Unix(1612283055, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func assetsReporterJobYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/reporter/job.yaml", size: 1347, mode: os.FileMode(420), modTime: time.Unix(1610644557, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
