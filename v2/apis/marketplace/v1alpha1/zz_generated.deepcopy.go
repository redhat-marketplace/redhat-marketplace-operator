...
func (in *MeterBaseSpec) DeepCopyInto(out *MeterBaseSpec) {
	*out = *in
	...
	if in.MeterdefinitionCatalogServer != nil {
		...
		*out = new(MeterdefinitionCatalogServerSpec)
		**out = **in
	}
	...
	out.ExternalPrometheus = in.ExternalPrometheus
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeterdefinitionCatalogServerSpec) DeepCopyInto(out *MeterdefinitionCatalogServerSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeterdefinitionCatalogServerSpec.
func (in *MeterdefinitionCatalogServerSpec) DeepCopy() *MeterdefinitionCatalogServerSpec {
	if in == nil {
		return nil
	}
	out := new(MeterdefinitionCatalogServerSpec)
