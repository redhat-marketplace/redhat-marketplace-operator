...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EntryKey) DeepCopyInto(out *EntryKey) {
	*out = *in
	if in.MeterDefinitionList != nil {
		in, out := &in.MeterDefinitionList, &out.MeterDefinitionList
		*out = make([]MeterDefinitionList, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EntryKey.
func (in *EntryKey) DeepCopy() *EntryKey {
	if in == nil {
		return nil
	}
	out := new(EntryKey)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in EntryMapping) DeepCopyInto(out *EntryMapping) {
	{
		in := &in
		*out = make(EntryMapping, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EntryMapping.
func (in EntryMapping) DeepCopy() EntryMapping {
	if in == nil {
		return nil
	}
	out := new(EntryMapping)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *MeterDefinitionReference) DeepCopy() *MeterDefinitionReference {
	...
	out := new(MeterDefinitionReference)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeterdefinitionStore) DeepCopyInto(out *MeterdefinitionStore) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeterdefinitionStore.
func (in *MeterdefinitionStore) DeepCopy() *MeterdefinitionStore {
	if in == nil {
		return nil
	}
	out := new(MeterdefinitionStore)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MeterdefinitionStore) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeterdefinitionStoreList) DeepCopyInto(out *MeterdefinitionStoreList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]MeterdefinitionStore, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeterdefinitionStoreList.
func (in *MeterdefinitionStoreList) DeepCopy() *MeterdefinitionStoreList {
	if in == nil {
		return nil
	}
	out := new(MeterdefinitionStoreList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *MeterdefinitionStoreList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeterdefinitionStoreSpec) DeepCopyInto(out *MeterdefinitionStoreSpec) {
	*out = *in
	if in.Entry != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeterdefinitionStoreSpec.
func (in *MeterdefinitionStoreSpec) DeepCopy() *MeterdefinitionStoreSpec {
	if in == nil {
		return nil
	}
	out := new(MeterdefinitionStoreSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MeterdefinitionStoreStatus) DeepCopyInto(out *MeterdefinitionStoreStatus) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make(status.Conditions, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MeterdefinitionStoreStatus.
func (in *MeterdefinitionStoreStatus) DeepCopy() *MeterdefinitionStoreStatus {
	if in == nil {
		return nil
	}
	out := new(MeterdefinitionStoreStatus)
	in.DeepCopyInto(out)
	return out
}
