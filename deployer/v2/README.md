# IBM&reg; Red Hat Marketplace Deployment Operator by IBM
...
The Red Hat Marketplace Deployment operator is used for cluster and operator subscription management on an Openshift cluster with the Red Hat Marketplace.
