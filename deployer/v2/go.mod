...
require (
	...
	github.com/banzaicloud/k8s-objectmatcher v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/prometheus-operator/prometheus-operator v0.57.0 // indirect
