The Red Hat Marketplace Operator provides cluster and operator management for Red Hat Marketplace customers.
### **Important Note**
...
The metering and deployment functionality have been seperated into two operators.
  - The deployment functionality remains as part of this Red Hat Marketplace Operator
...
1. The Red Hat Markeplace Operator prerequisites the Red Hat Marketplace Metering Operator. Installing the Red Hat Markeplace Operator with Automatic approval will also install the Red Hat Marketplace Metering Operator automatically. If performing an install with Manual approval, install the Red Hat Marketplace Metering Operator first.

#### The Red Hat Marketplace Metering Operator prequisites the following
