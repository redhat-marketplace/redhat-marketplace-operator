...
var _ = Describe("MeterbaseController", func() {
	...
	Describe("intergration tests", func() {

		BeforeEach(func() {

		})

		It("should create a prometheus subscription", func() {
			Expect(k8sClient.Create(context.Background(), meterbase)).To(Succeed())
		})

		It("should create prometheus", func() {
