...
func WithExpectedResults(o ...ReconcileResult) ApplyReconcileStepOptionFunc {
...
func WithUntilDone(o bool) ApplyReconcileStepOptionFunc {
	return func(c *reconcileStepOptions) error {
		c.UntilDone = o
		return nil
	}
...
func WithMax(o int) ApplyReconcileStepOptionFunc {
	return func(c *reconcileStepOptions) error {
		c.Max = o
		return nil
	}
